...
import edu.depaul.csc472.lanny.xul_final.helpers.InputValidation;
import edu.depaul.csc472.lanny.xul_final.sql.DatabaseHelper;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void verifyFromSQLite() {
        ...
        if (databaseHelper.checkUser(textInputEditTextEmail.getText().toString().trim()
            ...
            Intent accountsIntent = new Intent(activity, NoteMainActivity.class);
